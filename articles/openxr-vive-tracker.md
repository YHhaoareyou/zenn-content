...
この記事は大体、[この動画](https://youtu.be/Tw5LbNLW9Q4)を日本語訳して記事化したもの+自分の感想です。自分も実際に一通り設定して結果を確かめました。
...
\* あとは普通に自分がSteamVRのInput Binding（下の画像）が少し使いづらく、しかもなぜか結構効かなくなって再設定しないといけないことが多かったです...
